    ...
    >
      ...
      <nav className="flex-1 px-3 py-8 space-y-1 overflow-y-auto overflow-x-hidden">
        ...
        >
          ...
          <svg
            className={`ml-auto h-4 w-4 transition-transform ${isCollapsed ? "opacity-0 w-0" : "opacity-100"} ${isToolsOpen ? "rotate-90" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {!isCollapsed && isToolsOpen ? (
          <div id="sidebar-tools" className="ml-6 space-y-1">
            <Link href="/alati/kalkulator" className={subLinkStyle('/alati/kalkulator')}>
